migrate(
  (app) => {
    // 1. Clear existing levels to avoid duplicate numbers
    ...
    // 2. Insert new levels
    const levelsData = [
      { level_number: 1, name: 'Iniciante', min_xp: 0, max_xp: 99, icon: 'Star', color: '#9CA3AF' },
      {
        level_number: 2,
        name: 'Aprendiz',
        min_xp: 100,
    ...
    // 3. Clear existing achievements to avoid duplicate slugs
