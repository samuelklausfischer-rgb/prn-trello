...
export default function Admin() {
  // `ProtectedRoute` in App.tsx already guarantees we are an ADMIN when reaching this component.
  // We extract `user` just for display purposes if needed.
  useAuth()
    ...
    <div className="space-y-8 animate-fade-in pb-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-64">
          ...
          <Input placeholder="Buscar colaborador..." className="pl-9 bg-background border-border" />
        </div>
      </div>
          ...
          <CardContent className="p-0">
            <Table>
              <TableHeader className="bg-muted/50">
                <TableRow>
                  <TableHead className="font-semibold text-foreground py-4">Colaborador</TableHead>
